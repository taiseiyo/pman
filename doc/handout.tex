...
\begin{frame}[label={sec:org78d98bf},fragile]{Python 導入：source からビルド}
 メリット
\begin{itemize}
\item 最新バージョンが手に入る
\end{itemize}
...
\label{sec:orga3ab578}
\begin{frame}[label={sec:org5ea7cb9}]{pman コマンド}
発想
\begin{itemize}
