...
\begin{frame}[label={sec:orgbff4f23},fragile]{Python 導入：source からビルド}
 メリット
\begin{itemize}
\item 最新バージョンが手に入る
\end{itemize}
...
\label{sec:orgd60c2b1}
\begin{frame}[label={sec:org5201310}]{pman コマンド}
発想
\begin{itemize}
